...
from django.contrib.auth.forms import UserCreationForm,AuthenticationForm,UsernameField,PasswordResetForm,PasswordChangeForm,SetPasswordForm,PasswordResetForm
...
class MypasswordChangeForm(PasswordChangeForm):
    ...
    {'autofocus':'True','autocomplete':'current-password','class':'form-contol'}))
    new_password1=forms.CharField(label='New Password',widget=forms.PasswordInput(attrs=
    {'autocomplete':'current-password','class':'form-contol'}))
